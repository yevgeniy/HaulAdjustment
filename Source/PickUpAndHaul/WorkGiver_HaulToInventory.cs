...
public class WorkGiver_HaulToInventory : WorkGiver_HaulGeneral
{
    ...
    public override Job JobOnThing(Pawn pawn, Thing thing, bool forced = false)
    {
        ...
        if (StoreUtility.TryFindBestBetterStorageFor(thing, pawn, map, currentPriority, pawn.Faction, out var targetCell, out var haulDestination, true))
        {
            ...
            else if (ExtractThing(haulDestination, out var destinationAsThing) != null && (nonSlotGroupThingOwner = destinationAsThing.TryGetInnerInteractableThingOwner()) != null)
            {
    ...
    public static Thing ExtractThing(IHaulDestination t, out Thing thing)
    {
        thing = null;
